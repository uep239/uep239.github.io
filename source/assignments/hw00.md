...
Please include the approximate number of hours spent on this assignment in your README (including time spent on setting up your computer). Also use the README to outline the details of your submission, cite any references, and note anyone you received help from or discussed the assignment with. Finally, feel free to utilize the README for providing feedback and sharing your thoughts. For an additional two (2) points, include a funny image in your README using Markdown syntax.
...
-  Getting Started (15)
    - `enironment.yml` (14)
    - `os.txt` (1)
- Formal Pseudocode (50)
    - `mutiply.md` (10)
    - `square.md` (10)
    - `power.md` (10)
    - `divide.md` (10)
    - `modulo.md` (10)
- Abstract Pseudocode (30)
    - `nutella.md` (1)
    - `peanut.md` (1)
    - `turkey.md` (1)
    - `cheese.md` (1)
