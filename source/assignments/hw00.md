...
- `2 to the power of -5` should return `0`
...
All of your Markdown files should be nearly formatted and pleasant to read both as raw and rendered Markdown text. Check the Visual Studio Code or GitHub Markdown preview before submitting to ensure your files look as you expect.
